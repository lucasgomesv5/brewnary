...
- **RabbitMQ Documentation** — https://www.rabbitmq.com/docs — Documentacao oficial do RabbitMQ, cobrindo exchanges, queues, bindings e patterns de mensageria
- **Apache Kafka Documentation** — https://kafka.apache.org/documentation/ — Documentacao oficial do Kafka, incluindo arquitetura, consumers, producers e Kafka Streams
