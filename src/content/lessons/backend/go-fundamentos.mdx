...
- **Go Documentation** — https://go.dev/doc — Documentacao oficial da linguagem, incluindo tutoriais e especificacao
- **Go by Example** — https://gobyexample.com — Exemplos praticos e anotados de cada conceito da linguagem Go
