---
title: "Next.js — SSR, SSG e Full-Stack React"
description: "App Router, Server Components, SSR, SSG, ISR, API Routes, middleware, caching, deploy e as decisões arquiteturais para aplicações React em produção"
track: "frontend"
order: 10
section: "Frameworks"
priority: "high"
...
keyTakeaways:
  - "Next.js é o framework React full-stack dominante: App Router com Server Components é o padrão moderno, mas Pages Router ainda é amplamente usado"
  - "Server Components (RSC) rodam no servidor e enviam HTML + payload serializado — reduzem bundle size e permitem acesso direto a banco/filesystem"
  - "SSR, SSG, ISR e PPR são estratégias de rendering com trade-offs distintos entre freshness, performance e custo de infraestrutura"
  - "O sistema de caching do Next.js tem 4 camadas: Request Memoization, Data Cache, Full Route Cache e Router Cache — entender cada uma evita bugs sutis"
  - "Middleware, route handlers, server actions e revalidation são as primitivas para construir aplicações full-stack sem API separada"
---
